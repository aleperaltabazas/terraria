...
robert = Personaje
  { _nombre = "Roberto"
  , _ropa   = Ropa { _superior = "Remera roja"
                   , _inferior = "Jean azul"
  ...
  , _gafas  = Gafas
                { _armazon = Hierro
                , _decoracion = Esmeralda
                , _lentes = Lentes { _material = Polimero, _graduacion = 0.25 }
                }
  }
...
graduacion =
  lens _graduacion (\lentes graduacion -> lentes { _graduacion = graduacion })
